"""
Test render-sync-render round-trip for optional_vs_sequential_story_graph.
...
def main():
    ...
    print(f"\n{'='*80}")
    print("OPTIONAL VS SEQUENTIAL STORY GRAPH ROUND-TRIP TEST")
    print(f"{'='*80}")
    
    # Step 1: Given - verify input data exists
    print("\nGIVEN: Verify input data exists...")
    given_dir = test_dir / "1_given"
    story_graph_path = given_dir / "story-graph-optional-vs-sequential.json"
