# Story Writing Training Content

## Extracted from PowerPoint: "1) Story Writing Training.pptx"

### Slide 1: Focus Story Maps on User *AND* System Activities
- Epic, Feature, Story hierarchy
- Story sizing examples (15D, 7d, 5d)
- Avoid: Arbitrarily decomposing stories to a functional level, regardless of size
- Avoid: Building the map in absence of the people who can estimate the work
- Encourage: Asking how "big or small are the stories in the map?" promoted to production
- Encourage: Breaking / Grouping stories so that most fall into a 3 – 12 day effort range
- Benefits: Enable frequent feedback by decomposing the work into smaller items
- Benefits: Enable high quality feedback by grouping work into meaningful chunks

### Slide 2: Stories Need to Balance Being Fine-Grained As Well As Testable/Valuable
- Avoid: Generic function, verbs, nouns
- Avoid: Overly technical, IT concepts, unless core to domain being discussed
- Encourage: Focusing the language on the business domain
- Encourage: Validating that a business expert can understand the language of most of the stories
- Benefits: A common artifact that serves a wide variety of stakeholders
- Benefits: Lightweight but precise documentation over a tome of illegible content

### Slide 3: Ground the Map in Business Language That is Specific and Precise
- Agile is all about breaking big projects into smaller units of work that can deliver business value
- Big projects and big releases are hard! Lots of variability and unknowns! Lots of dependencies!
- Efficiency takes a back seat to delivering smaller features to the market sooner
- Avoid: Static functional concepts
- Encourage: Verb /Noun language
- Encourage: Language that emphasize performing an operation on an explicit thing
- Benefits: The map is easy to walk through, i.e. it tells a story
- Benefits: Gaps in flow make it easier to spot where the solution may be incomplete

### Slide 4: Favor Active Behavioral Language Over Functional / Capability Breakup
...
### Slide 5: Planning, Scheduling and Forecasting
...
### Slide 6: Velocity and Pointing Approach
...
### Slide 7: Limitations of Point-Based Estimation
...
### Slide 8: Like Sands in an Hourglass So Goes The Stories In Our Teams Lives
...
### Slide 9: Planning Is Made Simple By Calculating Throughput and Volume
...
### Slide 10: Relative Sizing Upstream
...
### Slide 11: Story Throughput Approach
...
- INVEST principles: Negotiable, Testable, Valuable, Estimate-able, Small, Independent

### Slide 13: Describing Stories Through Acceptance Criteria
...
### Slide 14: Best Practices for Writing a User Story
...
### Slide 15: Story Format Discussion
...
- HOWEVER: This format is frequently mis-used and attempted to be applied to work that does not require any of the above outcomes to be successful
...
- Many agile teams use the: As A <User> I Want To <Perform Action> So That <I Receive Value>

### Slide 16: Story Exploration In A Nutshell
...
- Other Helpful Agile Artifacts: Planning Game, UX, Architecture Modeling, Spec By Example, Domain Driven Design
...
1. **Story Mapping** - Creating story maps with epic/feature/story hierarchy, focusing on user and system activities
2. **Story Sizing** - Ensuring stories are appropriately sized (3-12 days), balancing fine-grained with testable/valuable
3. **Story Language** - Using business language that is specific, precise, and behavioral
4. **Planning & Forecasting** - Using throughput and volume for planning rather than just points
5. **Relative Sizing** - Comparing initiatives and increments against previously delivered work
6. **Story Exploration** - Deep dive into stories for upcoming delivery, including acceptance criteria
7. **Story Writing** - Writing stories following INVEST principles and best practices
8. **Acceptance Criteria** - Defining clear acceptance criteria for stories
