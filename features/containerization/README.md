...
3. **Run Deployment**:
   ```bash
   python features/containerization/ai-assisted-deployment/ai-assisted-deploy.py --feature "my-feature"
   ```

### Logging

Each deployment creates a timestamped log file in `features/containerization/logs/`:
